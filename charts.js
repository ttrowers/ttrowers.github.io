...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    // var washFreq = parseFloat(metadaResult.wfreq);
    ...
    var barLayout = {
      title: `Top Ten Bateria Cultures Found in Sample ${sample}`
    };
...
var gaugeData = [
  {
    ...
    gauge: {
      axis: { range: [null_10], tickwidth: 1, tickcolor: "darkblue" },
      bar: { color: "black" },
      bgcolor: "white",
      borederwith: 2,
      bordercolor: "grey",
...
Plotly.newPlot("gauge", gaugeData, gauge);
